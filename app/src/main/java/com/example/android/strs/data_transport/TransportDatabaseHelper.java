...
public class TransportDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "TransportRegistration.db";
    public static final String TABLE_NAME = "TransportRegistration";
    ...
    private static final String TABLE_CREATE = "create table TransportRegistration (TName text not null,TSource text not null," +
            "TDestination text not null,JTime text not null,Cost text not null,DDate text not null,DTime text not null,Seats text not null,CUsername text not null)";
    ...
    public void insertContact(TransportContact t)
    {
   ...
   public List<TransportContact> getDataFromDB(){
        ...
        List<TransportContact> modelList = new ArrayList<TransportContact>();

        if (cursor.moveToFirst()){
            do {
                TransportContact model = new TransportContact(cursor.getString(0),cursor.getString(1),cursor.getString(2),cursor.getString(3),cursor.getString(4),cursor.getString(5),cursor.getString(6),cursor.getString(7),cursor.getString(8));
    ...
    public void modify(String company,String name, String seats)
    {
        SQLiteDatabase db = this.getWritableDatabase();

        int value=Integer.parseInt(seats);
        value--;
        String updated_seats = String.valueOf(value);

        String query = "UPDATE "+ TABLE_NAME +" SET Seats="+updated_seats+" WHERE CUsername='"+company+"' and TName='"+name+"'";
